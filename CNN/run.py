...
class trainingCNN:
    ...
    def SelectCNNModel(self):
        ...
        self.SelectModel.compile(optimizer='rmsprop', loss='binary_crossentropy', metrics=['accuracy'])
    ...
    def PlotTrainingModel(self):
        Loss, Acc, ValLoss, ValAcc = SaveHistory(self.SelectModel, self.HistoryPath)
        PlotHistory(Loss, Acc, ValLoss, ValAcc, self.HistoryPath)
